...
#      await message.delete()
  ...
  if "amogus" in str(message.content).lower():
    await message.add_reaction("<reissus:866770971447918673>")
  ...
  if message.channel.type is discord.ChannelType.private:
    ...
    botAdminSlur = False
    slurColour = 000000
    if str(message.author.id) == "315193131282726914":
      botAdminSlur = True
      slurColour = 0xc20000
    ...
    if botAdminSlur:
        embedVar.set_footer(text="Owner violation - the violating message was not deleted.. | Novasaur")
